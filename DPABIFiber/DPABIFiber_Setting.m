...
Cfg.StructuralConnectomeMatrix.WeightedByImage.ImageFileSpace='T1w'; % T1w/anat or ACPC
...
Cfg.SeedBasedStructuralConnectivity.TWFC.FCFileSpace='T1w'; % T1w/anat or ACPC
